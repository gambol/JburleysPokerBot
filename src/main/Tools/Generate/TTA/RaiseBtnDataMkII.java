...
public class RaiseBtnDataMkII
{
    ...
    private static void main() throws Exception
    {
        ...
        //Glyphs:
        BufferedImage zero  = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\0.png"));
        BufferedImage one   = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\1.png"));
        BufferedImage two   = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\2.png"));
        BufferedImage three = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\3.png"));
        BufferedImage four  = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\4.png"));
        BufferedImage five  = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\5.png"));
        BufferedImage six   = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\6.png"));
        BufferedImage seven = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\7.png"));
        BufferedImage eight = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\8.png"));
        BufferedImage nine  = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\9.png"));
        BufferedImage p  = ImageIO.read(new File("Tess3\\Visuals\\research\\CoreVisuals\\RaiseBtn\\p.png"));
...
/*                System.out.println(i +"::: Match % " + match + " Match Found.");
        ...
        //System.out.println(Unit_XY_and_number.get(0));
        ...
        main.Switchboard.setRaise(convert);
    }

    private static BufferedImage scrapexIII()
    {
        BufferedImage image  = Screen.getBimage();
        Rectangle r = main.Tools.Generate.Locations.crf(0);
