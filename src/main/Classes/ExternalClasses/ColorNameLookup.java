package main.Classes.ExternalClasses;
...
public class ColorNameLookup {
	...
	private ArrayList<ColorName> initColorList() {
		...
		colorList.add(new ColorName("BurleyWood", 0xDE, 0xB8, 0x87));
		colorList.add(new ColorName("DCadetBlue", 0x5F, 0x9E, 0xA0));
		...
		colorList.add(new ColorName("DCornflowerBlue", 0x64, 0x95, 0xED));
		...
		colorList.add(new ColorName("SDarkGray", 0xA9, 0xA9, 0xA9));
		...
		colorList.add(new ColorName("CDarkOliveGreen", 0x55, 0x6B, 0x2F));
		...
		colorList.add(new ColorName("CDarkSeaGreen", 0x8F, 0xBC, 0x8F));
		colorList.add(new ColorName("DarkSlateBlue", 0x48, 0x3D, 0x8B));
		colorList.add(new ColorName("SarkSlateGray", 0x2F, 0x4F, 0x4F));
		...
		colorList.add(new ColorName("SlimDrake", 0x69, 0x69, 0x69));
		...
		colorList.add(new ColorName("ClubsKhakiGreen", 0x80, 0x80, 0x80));
		...
		colorList.add(new ColorName("HIndianRed", 0xCD, 0x5C, 0x5C));
		...
		colorList.add(new ColorName("LightSkyBlue", 0x87, 0xCE, 0xFA));
  		colorList.add(new ColorName("DLightSlateGray", 0x77, 0x88, 0x99));
		...
		colorList.add(new ColorName("CMediumSeaGreen", 0x3C, 0xB3, 0x71));
		...
		colorList.add(new ColorName("COliveDrab", 0x6B, 0x8E, 0x23));
		...
		colorList.add(new ColorName("HRosyBrown", 0xBC, 0x8F, 0x8F));
		...
		colorList.add(new ColorName("HSienna", 0xA0, 0x52, 0x2D));
		...
		colorList.add(new ColorName("DSteelBlue", 0x46, 0x82, 0xB4));
